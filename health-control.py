...
class Paciente:
    ...
    def add_peso(self, peso: float, data:date = date.today()):
        self.peso[len(self.peso)] = {'data:': data, 'peso': peso}
    
    def add_altura(self, altura, data = date.today()):
        self.altura[len(self.altura)] = {'data:': data, 'peso': altura}
...
def use_case():
    ...
    sintomas = {}
    sintomas[0] = Sintoma('febre', data, 38.3)
